...
from . import networks, improved_losses
...
class SegCycleGANModel(BaseModel):
    ...
    The model has been adapted to work with the Segmentation task.
    Add New Losses:
    ...
    Furthermore, the identity loss has been removed from the model.
    """
    @staticmethod
